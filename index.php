...
<head>
    ...
    <title>Alyssa Keimach | Articles</title>
...
<?php
$query = "SELECT * FROM project WHERE project.astro_tag = 1 ORDER BY project.timein DESC";
    ...
    <section id="other" class="container content-section">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h2>Other Works</h2>
<?php
$query = "SELECT * FROM project WHERE project.astro_tag = 0 ORDER BY project.timein DESC";
$result = mysql_query($query);
